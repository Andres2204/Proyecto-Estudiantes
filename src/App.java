            ...
            try {
                ...
                switch (menu()) {
                    case 1: // Añadir estudiante.
                        ...
                        , joption("Apellido estudiante:", true)
                            , joption("Carrera estudiante:", true)
                            , joption("Cedula estudiante:", true));
                        break;
                    case 2: // mostrar estudiantes.
                        int opc = Integer.parseInt(joption("Mostrar estudiante en espesifico?\n1. estudiantes espesifico.\n2.Todos.", true));
                        if(1 == opc) {
                            joption(mostrar_estudiante_completo(estudiantes, joption("Cedula", true)), false);
                        } else if (2 == opc) {
                            joption(mostrar_estudiantes(estudiantes), false);
                        } else joption("Opcion invalida.", false);
